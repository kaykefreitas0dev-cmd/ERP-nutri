...
last_updated: 2026-05-20 (autônomo cont. — PRs #108-#109)
...
- [~] Feat(web) — Renomear rótulo de dia inline no editor de planos: heading clicável → input pré-preenchido, Enter/blur salva, Escape cancela, Pencil icon group-hover; optimistic update com revert em falha; updateMealPlanDayLabelAction (max 60 chars) (PR #110 — em CI)
