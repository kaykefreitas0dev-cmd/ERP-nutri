...
export default async function AdminOrgDetailPage({ params }: Props) {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      {/* Memberships */}
      <section className="mt-6 rounded-lg border border-border-subtle bg-white shadow-sm">
        ...
        {memberships.length === 0 ? (
          <p className="p-5 text-sm text-text-muted">Sem membros.</p>
        ) : (
      ...
      <section className="mt-6 rounded-lg border border-border-subtle bg-white shadow-sm">
        ...
        {recentPatients.length === 0 ? (
          <p className="p-5 text-sm text-text-muted">Sem pacientes.</p>
        ) : (
