    ...
    <form action={handleSubmit} className="mt-4 space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <div className="sm:col-span-2">
          <label htmlFor="measuredAt" className="block text-xs font-medium">
            Data da medição
          </label>
          <input
            id="measuredAt"
        ...
        <div>
          <label htmlFor="protocol" className="block text-xs font-medium">
            Protocolo
          </label>
          <select
            id="protocol"
      ...
      <fieldset>
        ...
        <div className="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <div>
            <label htmlFor="heightCm" className="block text-xs font-medium">
              Altura (cm)
            </label>
            <input
              id="heightCm"
