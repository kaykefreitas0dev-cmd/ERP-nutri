...
const STATUS_LABEL: Record<string, { label: string; color: string }> = {
  ...
  CANCELLED: { label: "Cancelada", color: "bg-bg-muted text-text-secondary" },
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-6">
      ...
      {appointments.length === 0 ? (
        <div className="mt-6 rounded-lg border border-dashed border-border-default bg-white p-8 text-center text-text-secondary">
...
function AppointmentItem({
  ...
  return (
    <li className="rounded-lg border border-border-subtle bg-white p-3 shadow-sm">
